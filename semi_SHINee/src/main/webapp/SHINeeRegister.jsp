            ...
            <div class="TabColor"><img src="images/mypage.png" class="TabiconImage"><strong class="TabTextStyle">회원 가입</strong> 
                ...
                <form id="createAccount" action="SHINeeRegisterServlet" method="post">
	                ...
	                <div>
	                    ...
	                    <input id="pw" name="pw" type="password" oninput="pwCheck()"  placeholder="비밀번호" required>
	                    <p id="rulepm"></p>
	                </div>
	                <div>
	                    <label for="checkpw">
	                    ...
	                    <input id="checkpw" type="password" oninput="pwCheck()" placeholder="비밀번호 확인" required>
	                ...
	                <div>
	                    ...
	                    <input id="emailid" name="emailid" type="email" placeholder="myemail" required>
	                    <p id="ruleemail"></p>
	                </div>
	                <div>
	                    ...
	                    <input id="phoneNumber" name="phoneNumber" type="text" placeholder="01012345678" required>
